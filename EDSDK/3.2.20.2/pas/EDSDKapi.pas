...
const
  edsdk = 'D:/Delphi/Canon Remote/EDSDK/3.2.20.2/dll/EDSDK.dll';
...
function EdsCreateMemoryStream(bufferSize: EdsUInt32;
                               var stream: EdsStreamRef): EdsError; stdcall; external edsdk;
...
function EdsWrite(streamRef: EdsStreamRef;
                      writeSize: EdsUInt32;
                  var buffer;
                  var writtenSize: EdsUInt32): EdsError; stdcall; external edsdk;
...
function EdsGetPosition(streamRef: EdsStreamRef;
                        var position: EdsUInt32): EdsError; stdcall; external edsdk;
...
function EdsGetLength(streamRef: EdsStreamRef;
                      var length: EdsUInt32): EdsError; stdcall; external edsdk;
...
function EdsSaveImage(imageRef: EdsImageRef;
                          imageType: EdsTargetImageType;
                          saveSetting: EdsSaveImageSetting;
                          tStreamRef: EdsStreamRef): EdsError; stdcall; external edsdk;
...
function EdsCacheImage(imageRef: EdsImageRef;
                           useCache: EdsBool): EdsError; stdcall; external edsdk;
...
function EdsReflectImageProperty(imageRef: EdsImageRef): EdsError; stdcall; external edsdk;
