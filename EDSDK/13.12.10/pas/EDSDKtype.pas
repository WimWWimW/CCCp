...
// DC Properties
// ----------------------------------
      kEdsPropID_DC_Zoom                        = $00000600;
      kEdsPropID_DC_Strobe                    = $00000601;
...
// -----------------------------------------------------------------------------
    ...
    type EdsDrivePowerZoom = EdsUInt32; 
    const
...
// -----------------------------------------------------------------------------
    ...
    EdsImageQuality_HEIFL            = $0080ff0f;    // HEIF Large
    EdsImageQuality_RHEIFL           = $00640080;    // RAW  + HEIF Large
    EdsImageQuality_CRHEIFL          = $00630080;    // CRAW + HEIF Large
...
// -----------------------------------------------------------------------------
    ...
    kEdsBatteryLevel2_Unknown        = $FFFFFFFE;
...
// -----------------------------------------------------------------------------
    ...
    type EdsDcLensBarrelState = EdsUInt32; 
    const
...
// -----------------------------------------------------------------------------
    ...
    type EdsDcRemoteShootingMode = EdsUInt32; 
    const
