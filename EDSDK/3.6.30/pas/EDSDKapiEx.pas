...
procedure CopyData(streamRef: EdsStreamRef; writeSize: EdsUInt64; tStreamRef: EdsStreamRef);
...
function  CreateMemoryStream(bufferSize: EdsUInt64): EdsStreamRef;
function  CreateMemoryStreamFromPointer(var userBuffer; bufferSize: EdsUInt64): EdsStreamRef;
function  CreateStream(var stream: EdsIStream): EdsStreamRef;
procedure DeleteDirectoryItem(dirItemRef: EdsDirectoryItemRef);
procedure Download(dirItemRef: EdsDirectoryItemRef; readSize: EdsUInt64; tStream: EdsStreamRef);
...
function  GetLength(streamRef: EdsStreamRef): EdsUInt64;
function  GetParent(ref: EdsBaseRef): EdsBaseRef;
procedure GetPointer(stream: EdsStreamRef; var pointer: Pointer);
function  GetPosition(streamRef: EdsStreamRef): EdsUInt64;
...
function  Read(streamRef: EdsStreamRef; inReadSize: EdsUInt64; var buffer): EdsUInt64;
...
procedure Seek(streamRef: EdsStreamRef; seekOffset: EdsInt64; seekOrigin: EdsSeekOrigin);
...
function  Write(streamRef: EdsStreamRef; writeSize: EdsUInt64; var buffer): EdsUInt64;
